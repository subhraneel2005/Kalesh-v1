...
function Banner() {
  return (
    <div className='min-h-screen w-full flex flex-col justify-center items-center'>
        <div className='w-full h-full flex justify-center gap-10 px-4 items-center'>
          ...
          <Image src="/logo1.svg"  width={500} height={500} alt='bannerImage' className='-z-10 opacity-80 flex justify-center items-center'/>
        </div>
    </div>
  )
}
